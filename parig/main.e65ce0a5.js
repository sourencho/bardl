this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var La = ['գտնել', 'այսօր', 'երկիր', 'կրկին', 'անգամ', 'կարող', 'ցուրտ', 'որոնք', 'մինչեւ', 'բանակ', 'առջեւ', 'արձակ', 'հազար', 'ուղիղ', 'որեւէ', 'զգալի', 'աւելի', 'դուրս', 'հաջող', 'խաղաղ', 'յաճախ', 'ուժեղ', 'երկար', 'դեղին', 'միջոց', 'բժիշկ', 'բարեւ', 'լուրջ', 'սկսիլ', 'բարձր', 'առանց', 'անդամ', 'ամուր', 'բերել', 'սկսաւ', 'հեռու', 'կանաչ', 'թեթեւ', 'անկախ', 'ծանօթ', 'կողմը', 'ուրիշ', 'քաղաք', 'միայն', 'հազիւ', 'համար', 'տեսակ', 'գնում', 'բոլոր', 'կեանք', 'նուրբ', 'օգնել', 'խումբ', 'աղքատ', 'սկսած', 'շուրջ', 'խոշոր', 'երկու', 'յաճախ', 'անուն', 'դպրոց', 'լեզու', 'վայրի', 'զաւակ', 'շրջան', 'աղջիկ'],
        Ta = ['անուշ', 'բումը', 'խաղայ', 'դարից', 'կռվել', 'խօսիմ', 'դարեր', 'կոլֆը', 'տասնի', 'կռիվը', 'ապրոն', 'գիտեն', 'ռուսը', 'չդնել', 'Սեւակ', 'փորին', 'թեպետ', 'խօսած', 'պրևոն', 'խոտէն', 'եփելէ', 'երաշտ', 'հյութ', 'ներսը', 'ֆրենչ', 'տեւիի', 'մղվող', 'բարձի', 'փթահը', 'կազեր', 'մտրակ', 'շերտը', 'թևերն', 'կրպակ', 'անգին', 'բերրի', 'հարցի', 'կաշվի', 'գիշեր', 'ոգիին', 'պղպեղ', 'բժիշկ', 'կամաց', 'տոհմը', 'մաներ', 'կրիկի', 'երգեց', 'ծնոքը', 'նշանը', 'կոդեր', 'ոտքին', 'պինար', 'վազքի', 'ջոդին', 'ցավեր', 'սերին', 'փուլը', 'հայու', 'խաչով', 'խոհեմ', 'այգիի', 'հոգիի', 'առթիւ', 'պիցցա', 'տուփը', 'դարձի', 'կրցած', 'հենած', 'փռէին', 'ասկից', 'կրկին', 'փրկեց', 'հետքն', 'նռնակ', 'մետալ', 'աղետի', 'ալոկն', 'օրերը', 'արիւն', 'խյուս', 'մութը', 'ծնկին', 'ճիւղի', 'իրենք', 'զգանք', 'կապեր', 'վազել', 'մխրճէ', 'լեմբը', 'օրիայ', 'առում', 'կտավը', 'մահեն', 'հոտին', 'գազից', 'նորին', 'խմբով', 'պոտաշ', 'տուֆը', 'կողով', 'հնչեղ', 'անթիվ', 'տօնին', 'սկիհը', 'կորով', 'իշխած', 'կարծե', 'երբէք', 'թանաք', 'անցան', 'ամէնը', 'մասով', 'շպարի', 'գրպան', 'թաղին', 'լքում', 'տենչը', 'պիեսի', 'փոխեց', 'քաշըը', 'ամոլը', 'վարգի', 'ռայսի', 'հագած', 'քերել', 'պապին', 'վիտէօ', 'եուրո', 'ղրկեն', 'անագի', 'կարիք', 'ծէսին', 'երթայ', 'վնասի', 'յաճախ', 'յօդեր', 'այլեւ', 'վարիչ', 'մտներ', 'օժտած', 'կիբեր', 'դիակը', 'խաղան', 'խույս', 'կրանյ', 'եվայի', 'կախեն', 'կրեմը', 'գրուի', 'պատին', 'քիմքի', 'դէմքի', 'նշման', 'պարող', 'ռազմի', 'օրէնք', 'բիլլի', 'արծիւ', 'հարավ', 'ազդեց', 'խրդին', 'ուտիք', 'գրվել', 'բիրին', 'միջակ', 'կնիքի', 'րարքը', 'յառաջ', 'տողեր', 'ծախսը', 'նուշը', 'նետած', 'ճաշել', 'գրքին', 'պատած', 'ընկան', 'փակեն', 'բերեց', 'թաթեր', 'թխման', 'ծովեր', 'մաժոր', 'ալիքի', 'աաջին', 'ազդակ', 'յոյսը', 'կթռչի', 'սրբոց', 'հայեր', 'բեմբի', 'տորթը', 'այրին', 'մետաղ', 'վանեն', 'բացին', 'զոհեր', 'ալիան', 'ճոլին', 'կողքի', 'սեղան', 'ձուկը', 'ապրիլ', 'ֆոլկի', 'ստեղի', 'նշուի', 'վագրի', 'լազեր', 'յամառ', 'կրակէ', 'ետեւը', 'ոսկյա', 'շինեն', 'տիրող', 'երազի', 'յիշած', 'օրինի', 'ցնցած', 'հենէր', 'յարգի', 'սքոթը', 'մասոն', 'լատին', 'կրթել', 'ախյալ', 'բողոք', 'հոգան', 'եփված', 'մոտիվ', 'սթեդը', 'լարով', 'բոյսը', 'տհոլի', 'իրբեւ', 'հազիվ', 'վստահ', 'հակին', 'իրենն', 'բներգ', 'ֆոնին', 'կարծր', 'պետիի', 'վառել', 'ուղին', 'տեսավ', 'ցանկը', 'տօնով', 'սկսկի', 'կաճին', 'սերել', 'ներու', 'քիրազ', 'կորավ', 'կընէր', 'վարկը', 'ականջ', 'արածն', 'ֆերմա', 'մոդալ', 'տեսել', 'գուֆը', 'Ջորջը', 'եղիցի', 'բաժնի', 'տողով', 'գիւտը', 'բերեն', 'թռչիլ', 'հետևի', 'օվալի', 'պոեմն', 'ուէսթ', 'լողով', 'սրինգ', 'միոզի', 'խելքի', 'գնացք', 'վառած', 'Գաւառ', 'քակած', 'եչկար', 'չղջիկ', 'երթեր', 'ամօթի', 'սոված', 'բաժակ', 'ցաւօք', 'ազոտը', 'սոֆիա', 'ալիսա', 'եւրոն', 'ճնշող', 'գոտին', 'ավագի', 'ազդու', 'բանին', 'կորքի', 'բիոմի', 'բեմէն', 'տարրը', 'ջրերն', 'կետին', 'դիրքի', 'կեղտը', 'դարին', 'էյմսի', 'մինաս', 'պիեսն', 'ատեան', 'գունդ', 'տեղիք', 'չբանի', 'եղբօր', 'խազել', 'նիզակ', 'ժպտիր', 'եզրեր', 'կատակ', 'աչքին', 'երեսի', 'մնալէ', 'լապշա', 'ռապախ', 'մտգով', 'դուրս', 'բժիղկ', 'կանոն', 'մշուշ', 'մահին', 'մահէն', 'ջազից', 'բիթիի', 'պատից', 'ափերի', 'դիմել', 'դիզեց', 'գեննա', 'արարք', 'վեջին', 'իզմիր', 'տիրոջ', 'կաճէր', 'իչհոն', 'քերած', 'խմում', 'հողէն', 'հրէշը', 'ներսի', 'փոխեն', 'խօսին', 'հեծիկ', 'դեմքի', 'սկսան', 'իտէալ', 'գոլֆի', 'տանձի', 'արևոտ', 'մատնէ', 'պահոց', 'նըւէօ', 'թացան', 'դայակ', 'լինէր', 'գաղձը', 'տեղից', 'օհայո', 'մայիս', 'բջիջի', 'միակն', 'պնդեց', 'գիրով', 'անջատ', 'կացաւ', 'բուրդ', 'ձայնի', 'մահից', 'փախած', 'էթիկա', 'ոտքեր', 'ծայրը', 'կռելի', 'վարքի', 'կարոն', 'նշանի', 'մոտիկ', 'մուրը', 'աշուղ', 'կովեր', 'գութը', 'կույս', 'ամսից', 'մորիս', 'վզիկի', 'ասդին', 'հրեշի', 'մարզը', 'էշարք', 'իրանի', 'բրեան', 'բացած', 'դրդել', 'մկանը', 'ձյուն', 'ցաւեր', 'բախին', 'ծանոթ', 'լոկալ', 'գտնայ', 'վոկալ', 'գրողը', 'այծեր', 'քանզի', 'փորձը', 'անզեն', 'չլսեց', 'աղեղը', 'ստելը', 'ճյուղ', 'գոլին', 'ընտրի', 'վճիռն', 'այսպէ', 'խղճին', 'սպայի', 'մտքէն', 'կխժռի', 'ռոուզ', 'դուետ', 'գագիկ', 'չորսը', 'վշտից', 'տոկայ', 'ծրարը', 'հիմեն', 'օծուն', 'պակեթ', 'համար', 'շնչին', 'թերթը', 'թակած', 'չափիչ', 'ամառն', 'կսկսի', 'ապրիմ', 'ձեռքէ', 'էջերը', 'հադին', 'վազեր', 'իմաստ', 'լուալ', 'իրենձ', 'ներքո', 'ճաշէն', 'նետել', 'ոսկիէ', 'քավեր', 'ամպոտ', 'ցցվող', 'կարսը', 'դաշտի', 'ձիւնի', 'պանան', 'դիտել', 'գաղթի', 'ծախքը', 'տղայի', 'բերդի', 'ձմեռը', 'սալթա', 'կապից', 'առիթն', 'ստոյգ', 'երգչի', 'զինքը', 'բծերի', 'աքսոր', 'մերժէ', 'հազիւ', 'անագը', 'վարքը', 'կապար', 'կտրել', 'ելակը', 'երևալ', 'կնոջն', 'բնտրէ', 'գնվել', 'շուշի', 'խնձոր', 'ցանցի', 'մժեղը', 'տիֆով', 'դիրքն', 'գինին', 'թույն', 'հրիայ', 'անտիկ', 'վճռեց', 'յուղն', 'կույտ', 'խոհեր', 'փօլիօ', 'նշված', 'սաներ', 'մտքով', 'բժշկի', 'շարքը', 'ավագը', 'գլխու', 'վարդի', 'հողեր', 'մղում', 'ֆայհա', 'գաղթը', 'հարկի', 'պետին', 'կամքը', 'պատմէ', 'հղկել', 'սառցե', 'հիւթը', 'խնդրէ', 'կաթին', 'զանգը', 'մաշկի', 'եզակի', 'քիքին', 'ցեղից', 'բիցցա', 'ոգուն', 'միջից', 'թուրը', 'վնասէ', 'կանչը', 'ամենի', 'անմահ', 'կառքը', 'պղնձե', 'սմբակ', 'ռեփին', 'զննել', 'մէկու', 'անխնա', 'օղակի', 'խաւոտ', 'սիկհը', 'դիտէր', 'կողքը', 'շնորհ', 'դարէն', 'պլուզ', 'բանար', 'ազոտի', 'սեքսի', 'օրհնի', 'գանկի', 'ցրվել', 'թանչը', 'ինձմէ', 'գինու', 'պարած', 'որոնք', 'ագահը', 'գոցեն', 'բուհը', 'արժէք', 'կտաւն', 'տրվող', 'հոգին', 'երեւի', 'տխուր', 'քույր', 'ֆավնի', 'պէքոֆ', 'բտիլն', 'կեքսի', 'գոտու', 'շղթան', 'նկուղ', 'ամսին', 'հորից', 'ճկուն', 'անզէն', 'նիզար', 'նշենք', 'լիզան', 'կարդա', 'խաբել', 'բագին', 'շարլֆ', 'դրօշը', 'ժխտող', 'փափաք', 'խումբ', 'մերլի', 'փողոց', 'դասել', 'աթէնք', 'վաշտի', 'նետեն', 'զարան', 'տօնեն', 'թաթար', 'վիճին', 'ծնեալ', 'շշերը', 'հոգալ', 'ջունի', 'տրամա', 'օջախն', 'շոուն', 'փայլը', 'կաշվե', 'հարին', 'միակը', 'հինին', 'մռայլ', 'կիշխէ', 'հասնի', 'իշխեց', 'ունէի', 'ոչխար', 'լճակն', 'երիզը', 'զսպող', 'փոշոտ', 'ոսկին', 'տօնէն', 'գոհար', 'ձիերի', 'չուտէ', 'ազդած', 'օրերս', 'չքնել', 'փոխած', 'վախով', 'ուռիլ', 'շատեր', 'դրոշի', 'շրջիկ', 'հավատ', 'ապազը', 'ձայնը', 'զուսպ', 'դիզած', 'ատոնց', 'կրօնն', 'դէմքը', 'կրթած', 'տոտալ', 'բերքը', 'վերան', 'արջեր', 'ճշրիտ', 'միհրը', 'գդակը', 'լաւաշ', 'սոճին', 'տաթևի', 'տիրէր', 'ոզնին', 'շարքն', 'գիհին', 'մէկնը', 'փոստը', 'քամին', 'թիթեռ', 'թողեր', 'ոտքով', 'ձգելի', 'բաժնէ', 'կաշիէ', 'փսարա', 'հօտով', 'առնել', 'խպիպի', 'յետին', 'կէսէն', 'այրու', 'ցերեկ', 'սկսիլ', 'բասրա', 'մեծաւ', 'կայան', 'անհետ', 'մեղքէ', 'այրեր', 'հիմնը', 'անսին', 'կողմը', 'մնալը', 'մյւոս', 'գլխին', 'Դուին', 'լոյսն', 'մեդիա', 'տաշած', 'պակաս', 'տոմար', 'ռինգը', 'տեղէն', 'զոյգը', 'ողորկ', 'երթալ', 'քաշել', 'ձկներ', 'քաշով', 'չգիտի', 'լսում', 'հոսքը', 'բանէն', 'խոցել', 'լծուի', 'շունն', 'տօներ', 'բերել', 'մինակ', 'դպրոց', 'փլվել', 'վավեր', 'տիսքօ', 'գրենք', 'տիպին', 'ոունի', 'ծեծով', 'ետևից', 'կտրող', 'նիւթը', 'նօրէն', 'հատեն', 'չքնաղ', 'մանգա', 'նշանն', 'իրերը', 'տեսնի', 'խաւին', 'ապչու', 'բարդը', 'ուղու', 'ակամա', 'բանայ', 'տևում', 'այլոց', 'բերան', 'դստեր', 'չպետք', 'սկսաւ', 'տինքի', 'խօսիր', 'գահից', 'պոլիս', 'զորքը', 'ֆիդես', 'ապակի', 'կոչել', 'ամիսը', 'սնուէ', 'ճնշէր', 'էտեղի', 'սեզոն', 'քաքաօ', 'ծնկան', 'դնում', 'տոտեմ', 'եղելէ', 'մոմով', 'իրարո', 'էթնիկ', 'ետեւի', 'ծագող', 'թոշակ', 'հացէն', 'շնիկի', 'որսին', 'հաուս', 'սանտր', 'դրամը', 'ձէթով', 'փաստն', 'թերևս', 'բանան', 'հովվի', 'վրձին', 'զարդը', 'տեմպե', 'օգնեն', 'մարքի', 'առնաս', 'խոնավ', 'քաղաք', 'հերթը', 'զատիկ', 'միջով', 'իխտիս', 'դադար', 'փախչի', 'կանտի', 'զանգի', 'քայլը', 'կէյթց', 'շինող', 'մեկնի', 'ռիոյի', 'հսկող', 'վրանն', 'հոլթը', 'ամառը', 'աստծո', 'սլենգ', 'կացնի', 'աջլիկ', 'սովէն', 'ասորի', 'յոյսի', 'բախած', 'տիկին', 'ամրան', 'սալիկ', 'թիւեր', 'տարրն', 'էդնան', 'թենիս', 'ժպտար', 'գրեցի', 'ջանար', 'երթան', 'ազդող', 'փերին', 'գանկը', 'սուտի', 'հանած', 'մեղքի', 'ռոքին', 'տուբը', 'թևերը', 'շոշոտ', 'անանկ', 'խաթար', 'չարու', 'օտենի', 'բիրնի', 'թէզեր', 'դանիա', 'մեդալ', 'գազան', 'խմելի', 'ազգեր', 'ուրկէ', 'գրոհը', 'մրգեր', 'ճնշել', 'իջնող', 'ռեժիմ', 'ուզած', 'սիպիլ', 'մասեր', 'դաւան', 'կտրեց', 'խոսքի', 'դունչ', 'հնաոճ', 'Զինան', 'եղբոր', 'յէտոյ', 'կարժէ', 'գարնի', 'բեմից', 'մղված', 'թրեպի', 'շարքի', 'քլորը', 'կռվին', 'գլասը', 'խավեր', 'սիրով', 'արկեր', 'գրեգը', 'տանկը', 'քարեր', 'լքասը', 'հսկեն', 'բազան', 'հնչել', 'մէջքը', 'երգին', 'վահան', 'շտրիխ', 'հատած', 'ոսկրի', 'դրամի', 'հյուն', 'զօրքի', 'ջրերի', 'փոստի', 'եփվող', 'խաղին', 'Թադէի', 'խաշին', 'ասոնք', 'այրիլ', 'պահէն', 'ձմրան', 'մեռաւ', 'կենայ', 'միսէն', 'գալիք', 'ռոմեո', 'զէնքը', 'դերին', 'թուրն', 'վարքն', 'մրցին', 'գիրքն', 'ինչին', 'քնելը', 'խաղաղ', 'սիւժէ', 'ամբոխ', 'հսկած', 'այրել', 'իրերն', 'շաքար', 'բարեւ', 'ցինկէ', 'զինքի', 'ազդրի', 'վաֆլե', 'Նևիլի', 'առջեւ', 'կոթող', 'մարաշ', 'պիեսը', 'մօտէն', 'կուռք', 'պէմօլ', 'ճտերը', 'երազէ', 'վրայի', 'ժանսը', 'դիակի', 'տիրել', 'շուկա', 'երեկո', 'ձախէն', 'բիլսը', 'մեկով', 'տրոլը', 'գրելը', 'ինջու', 'ներկի', 'մոնեն', 'լույս', 'ցավից', 'ծաղրն', 'մաքրէ', 'ճանճը', 'կետեր', 'թանին', 'անթիք', 'հերան', 'ոլորտ', 'գուցե', 'թեթեւ', 'բոզեի', 'բրդեա', 'շահին', 'տառեր', 'միրէյ', 'բաներ', 'կտաւէ', 'պահքն', 'թաւիշ', 'ընկեր', 'ամորֆ', 'դիջեյ', 'կիներ', 'ժահրի', 'գետնի', 'յաճակ', 'տարրի', 'փռուի', 'իպսեն', 'հիրիկ', 'երազն', 'փուռի', 'հավով', 'ներքը', 'լացող', 'վրացի', 'ատում', 'վանքն', 'տոներ', 'մեռած', 'գտնել', 'ջոկատ', 'լծված', 'մերին', 'Դադէի', 'տոֆու', 'թղթին', 'մոդել', 'գազեր', 'փոքրն', 'գտնէր', 'վիզին', 'ճառով', 'թէյին', 'դեմքը', 'բառէն', 'մնտել', 'ջնջեց', 'փիարօ', 'միայն', 'վճռած', 'կամար', 'կերտէ', 'պահքի', 'գետին', 'ձգտել', 'ծաւալ', 'աչում', 'երբեմ', 'շիլան', 'սիրտը', 'տորֆի', 'քասախ', 'ցցուի', 'ասիոյ', 'տեւած', 'տրեբլ', 'կրիոն', 'չուխա', 'թողեց', 'գօտին', 'ծոցեր', 'ամոթը', 'մայրս', 'սերով', 'համին', 'ներսն', 'երկեր', 'ձեռքի', 'վոքալ', 'ֆոնտը', 'բերէր', 'խփում', 'տհոլը', 'կապին', 'սանդի', 'կրծքի', 'կեցած', 'գծերը', 'ուղեղ', 'թժչին', 'կորիզ', 'զատել', 'նավթի', 'քարոզ', 'երկու', 'ոճերի', 'օրերն', 'սրանք', 'շաղիկ', 'մառեն', 'կրակը', 'հարել', 'կէտեր', 'փնջիկ', 'խօսիլ', 'տերևն', 'շերեփ', 'հարցը', 'չափից', 'քալեն', 'կապոտ', 'ասվել', 'թուզը', 'թերթն', 'ջամբէ', 'նշէին', 'վիճող', 'դռնից', 'շինեմ', 'դեռես', 'բաղեղ', 'այրող', 'որսով', 'ժիհատ', 'շրիտա', 'պատվի', 'ոսկու', 'հրատի', 'շեղբի', 'բլրոտ', 'տանէր', 'զաւակ', 'կուրս', 'իրերի', 'փախել', 'շինեց', 'դիմած', 'վարել', 'առակը', 'տնկած', 'իշխան', 'քերին', 'կառնէ', 'ջրվեժ', 'պարկի', 'ճիւղը', 'կրցաւ', 'սեռով', 'աճում', 'մասից', 'ռաման', 'հեյսը', 'խմբակ', 'զեման', 'աղցան', 'մասէն', 'մոմեր', 'վերջն', 'նիւթն', 'ասոլի', 'թյուն', 'ազգին', 'տուֆէ', 'ջուրէ', 'երգիչ', 'արված', 'հոլով', 'եռալը', 'սպիրտ', 'բոյնը', 'տվյալ', 'ըսածը', 'դհոլի', 'կլինի', 'խնամք', 'ծովու', 'զույգ', 'աղերս', 'լիմպա', 'ծիրէն', 'տայգա', 'ինչից', 'զարըգ', 'կնիքը', 'երգող', 'խմորը', 'ցատկէ', 'գյուղ', 'տրված', 'ձաւար', 'հնչող', 'բաժին', 'աշոտի', 'սրվել', 'վիճակ', 'գուաշ', 'հռեայ', 'մառան', 'աւագն', 'կրծեն', 'ծանօթ', 'ճառեր', 'լճում', 'տրուի', 'ոգիով', 'ստանա', 'իսլամ', 'գույն', 'ցուլի', 'պարով', 'մեջքն', 'տեսակ', 'լուրջ', 'շրջած', 'սոֆին', 'տուաւ', 'ծեսեր', 'լուծը', 'անուն', 'մէջէն', 'հիմնէ', 'շահիլ', 'ուսին', 'տարազ', 'հոբբի', 'թվերի', 'դերով', 'հրձիգ', 'գնդիկ', 'ափերը', 'առանց', 'թուղթ', 'թևիսի', 'կտածը', 'նկարէ', 'խաղող', 'բակին', 'Լևոնն', 'հորոր', 'թողու', 'հատող', 'նանտի', 'վախէն', 'ռոմբի', 'զենքն', 'իմամը', 'բառին', 'օինակ', 'շալէր', 'գիտեր', 'խրթին', 'ցնցել', 'բուտի', 'տարած', 'հարգի', 'մելիք', 'վուդը', 'մլեհը', 'տաղեր', 'նոտար', 'կերել', 'վճարը', 'շոլցը', 'թողած', 'քշէին', 'պատիժ', 'հումք', 'լողան', 'համառ', 'կողին', 'անվան', 'ջրիկն', 'դերէն', 'ամայի', 'կամեո', 'արեւը', 'պորտը', 'պետեր', 'բանկի', 'շրջան', 'առիւծ', 'ֆիտիլ', 'նազան', 'սիրեմ', 'ունակ', 'դեղձի', 'կտորը', 'վիգէն', 'իրանը', 'տեսած', 'փոսիկ', 'քննել', 'բերին', 'ելոյթ', 'տողէն', 'կրօնի', 'ճակատ', 'տէմին', 'միտէր', 'կեսին', 'զենքը', 'խոռոչ', 'լիներ', 'սկսիլ', 'ձեւեր', 'ամպեր', 'ուծին', 'կադրի', 'սկսած', 'խմիչք', 'խոսքը', 'մտքեր', 'թիմեր', 'շրջէր', 'հայրն', 'զատեն', 'գինով', 'սինգլ', 'ընտրէ', 'ծախեց', 'մշեցի', 'անօթի', 'կերգէ', 'փորձէ', 'օգնեց', 'բերնի', 'տեւէն', 'գրածը', 'աւիշի', 'աստղի', 'փաստի', 'թանից', 'դիմեն', 'անձիք', 'թրջեն', 'մեզմէ', 'սնուի', 'նայիլ', 'լիսէի', 'օճախը', 'ջիգան', 'կոանք', 'սաշան', 'գիտեմ', 'դժգոհ', 'տալու', 'փեթակ', 'մտնէր', 'միսին', 'հետին', 'կարոս', 'մեջքը', 'գանգի', 'նորէն', 'բերքի', 'շոուի', 'զօրու', 'հենել', 'երգից', 'զինկը', 'գոյնն', 'բացեն', 'ելքեր', 'տումի', 'հասավ', 'ծաղիկ', 'հալած', 'պաշար', 'չամիչ', 'շունը', 'էգանը', 'մասրե', 'բլիթի', 'նախշը', 'շտաբը', 'կուշտ', 'չերին', 'նստէր', 'տալով', 'ֆրիզի', 'լիճեր', 'բույր', 'խոշոր', 'լիլիթ', 'ամրոց', 'աբբաս', 'կակաչ', 'միտքի', 'իրաքի', 'բոսխի', 'սերած', 'մէկէն', 'կարել', 'սեւրի', 'կազով', 'էական', 'տատից', 'քուրք', 'ռիթմի', 'մոխրի', 'լիրան', 'տուֆի', 'նստեց', 'փակել', 'անամպ', 'դասած', 'նստին', 'ադրիկ', 'ամենը', 'ուշքի', 'թեյեր', 'կրէկի', 'շոգին', 'դասին', 'նուրբ', 'յենու', 'մնայէ', 'վասիլ', 'լոուն', 'ցարին', 'սերեր', 'քրոջս', 'ավազը', 'ոճում', 'փլված', 'շևենի', 'քայլն', 'պապից', 'ռադիո', 'մարդն', 'ըլլայ', 'կիկան', 'դրախտ', 'կըսեն', 'դրօշի', 'մաւեր', 'ամանի', 'ձգտած', 'վաֆլի', 'աւարտ', 'կպչել', 'աշնան', 'անում', 'ճահճի', 'թշվառ', 'ականի', 'գինիի', 'գծերի', 'աթինա', 'աւարի', 'մաղձի', 'բարիի', 'դեղեր', 'հավեր', 'նպաստ', 'որակի', 'գրողի', 'գովքն', 'տածեր', 'տուրք', 'մարզէ', 'հռչակ', 'ինկան', 'շտաբի', 'ջանայ', 'ջուտն', 'ջրերը', 'կանչէ', 'գիլան', 'ասածի', 'ծախած', 'գլխիկ', 'կրոնի', 'կացել', 'ուսից', 'առտու', 'ղազախ', 'բանտի', 'ձևերը', 'հոտեր', 'դուռը', 'ավագն', 'հիմքի', 'տունէ', 'արամէ', 'ուսէն', 'նայել', 'հարցն', 'պղնձի', 'օմանը', 'ճիգին', 'սօսին', 'կտաւի', 'սառիր', 'խորքի', 'պահքը', 'դիպել', 'թեւեր', 'սիրեր', 'տակով', 'սկսէր', 'լրտես', 'ծռված', 'միջեվ', 'խուրձ', 'թափել', 'սքեմը', 'տեխնո', 'հերոս', 'բանալ', 'հրդեհ', 'թամբը', 'ծառան', 'կատու', 'թխված', 'պասիվ', 'էփսին', 'տառին', 'սթեյք', 'փչովի', 'անսեռ', 'ադոնց', 'ծակոտ', 'պալէի', 'դեպքի', 'իւղով', 'աբսիդ', 'կազմը', 'միջոց', 'մուխի', 'աճման', 'բակից', 'գրերը', 'ամենա', 'գներն', 'սառած', 'ջուրն', 'դեպքն', 'թանձր', 'հազար', 'աղիւս', 'առկայ', 'ձմռան', 'թերին', 'ներեր', 'չափել', 'հարար', 'կողեր', 'գցեցի', 'բարու', 'գործն', 'պեկից', 'վանայ', 'խաշան', 'արուի', 'տուին', 'ցոյցը', 'դռնէն', 'բախտն', 'յանգի', 'սոխակ', 'յուղի', 'տեւեր', 'ջիղին', 'նշվել', 'քայլի', 'ճէյմս', 'գտնեն', 'ներքև', 'ելլել', 'սերոբ', 'քչերն', 'տորթի', 'բանից', 'արկղը', 'տների', 'իկթան', 'չեղած', 'սաղմը', 'անցավ', 'բոլոր', 'թռչող', 'զօրքը', 'կէսին', 'վայրն', 'ուզեց', 'նժարը', 'յենած', 'ծաղկի', 'գամմա', 'օսկոր', 'ռիթմը', 'պուէտ', 'ծեծէր', 'ըլլան', 'զեւսի', 'վթարի', 'բերաւ', 'դրվել', 'օրերէ', 'բանտը', 'Շանթի', 'ներկա', 'խարաֆ', 'սուգի', 'աղեղի', 'գրքից', 'գլանի', 'գալէն', 'փառքը', 'յաճախ', 'կուպր', 'մեկից', 'կարլը', 'ոմանց', 'յատնի', 'ուղիի', 'պարզէ', 'կիսել', 'կրելն', 'կայքի', 'սիրտի', 'գրոսը', 'ռեյնը', 'բռնկի', 'ռիատի', 'օգիեն', 'թվերը', 'շուրջ', 'այլևս', 'գրկել', 'էլենի', 'իրրեւ', 'հիւրը', 'տեղայ', 'տոնին', 'խնդրի', 'նաւթի', 'կորեկ', 'լեռան', 'գալու', 'ամռան', 'տարեց', 'ոժերն', 'կլանի', 'երգել', 'ցավոք', 'սրահէ', 'քամպօ', 'գորիս', 'զտուի', 'ծէսէն', 'գրէին', 'լարած', 'տիոնի', 'ուշիմ', 'ձիրքը', 'այնեղ', 'տեսքը', 'տեղին', 'գայլը', 'նոյնն', 'կապով', 'սյանը', 'աստղը', 'տեսաւ', 'ֆէսին', 'լծակը', 'գրելէ', 'սմբատ', 'օգտին', 'տարաւ', 'նաւակ', 'էգերը', 'ցնցեց', 'շահած', 'քատիս', 'ճնշեն', 'տեմպը', 'քնում', 'Ալանը', 'արթօն', 'անողի', 'կետով', 'քունի', 'նական', 'տափակ', 'ննջող', 'բառից', 'տարով', 'ապրեր', 'չեչիլ', 'պայթի', 'դրդած', 'ծածկն', 'պիրսն', 'սթեդի', 'ասացի', 'հովոց', 'ճարպի', 'կայտի', 'կողմն', 'մորին', 'սրբել', 'խմբից', 'հույս', 'ինկաւ', 'իրէնց', 'սովոր', 'պայէր', 'տեւեն', 'ցրված', 'լիճէն', 'խոսքն', 'սահքի', 'աշոտը', 'հատել', 'աջում', 'յարնէ', 'դրդեց', 'արձան', 'հեկթօ', 'զիրար', 'կելլէ', 'ձգված', 'աքսել', 'վաշտը', 'գագաթ', 'օճառի', 'դիտած', 'պելլը', 'տունն', 'հնում', 'նմանի', 'կիսատ', 'նավից', 'լոլիկ', 'աթենն', 'կախած', 'սևերի', 'կգնամ', 'եռանդ', 'տիպիկ', 'աչքէն', 'թիթեղ', 'նաֆթի', 'դէպքի', 'բացից', 'քրոջը', 'երկալ', 'հօտին', 'վառող', 'ուսաւ', 'վերեւ', 'ժպիտը', 'բրնձը', 'դարձը', 'անդիկ', 'գարթը', 'ապրող', 'խմորէ', 'շիտակ', 'հրթիռ', 'ֆոբիա', 'գնում', 'տոհմի', 'ոսկիի', 'լևոնի', 'թաղյա', 'կռվող', 'գօտիի', 'աւելի', 'պիլկի', 'հալէպ', 'ատոնք', 'կրծող', 'անդամ', 'ֆրանք', 'քանակ', 'պարտք', 'արուն', 'ցիկլի', 'փախան', 'ակտեր', 'կաճեն', 'ճեղքը', 'քարտի', 'չափեր', 'խռկալ', 'շղթայ', 'մեխակ', 'ինտիմ', 'խորէն', 'լոնգը', 'աչքեր', 'գանձը', 'կզգամ', 'հինէն', 'բիթրի', 'ճանկը', 'դրուի', 'գիրքի', 'լսէին', 'ոտքից', 'ասոնց', 'նեղոս', 'մուրճ', 'հարկէ', 'չափեց', 'Էրոսը', 'լոյսը', 'թիւին', 'կորել', 'կաթով', 'ոսկրէ', 'խնդիր', 'հերու', 'պլանի', 'տալէն', 'դաժան', 'թորին', 'էապես', 'կեսար', 'գրիչի', 'լաստի', 'քաոսի', 'կտորի', 'թափով', 'ռեգգի', 'պնդեր', 'բայից', 'կապոց', 'քաղցր', 'մազին', 'հէրին', 'հպարտ', 'մարտը', 'օգներ', 'առողջ', 'ուտես', 'նեյթը', 'լցոնն', 'դռներ', 'թաբեց', 'էապէս', 'շապիկ', 'կոճակ', 'մորթի', 'արզնի', 'ստորը', 'քլեյը', 'հարող', 'գնացի', 'մկանի', 'փորել', 'իվանը', 'բալադ', 'սուրը', 'ինչքի', 'գերբն', 'եռման', 'ինչով', 'մղվեց', 'կլիմա', 'թուղթ', 'օլգան', 'լոյսի', 'կական', 'ցեւով', 'փողից', 'սնկիկ', 'սահել', 'կապող', 'յիշել', 'խօսէր', 'ասում', 'թւում', 'ծնված', 'սրտին', 'ներկը', 'անցաւ', 'էպոսի', 'տեսնէ', 'բանակ', 'պատժի', 'բռնակ', 'մթնել', 'ասպետ', 'յառած', 'լալեի', 'որակը', 'քիվին', 'անհոգ', 'դնովի', 'ֆրիկը', 'իդիշի', 'զավակ', 'արվել', 'խաշած', 'ազգէն', 'աւազը', 'ջարդը', 'ուրիշ', 'լողալ', 'ոճերն', 'անձրև', 'տեքստ', 'քէշան', 'ծեծել', 'ափերն', 'երազս', 'պահէր', 'ղրիմի', 'գրման', 'տակէն', 'օպերա', 'հակած', 'գետեր', 'ավազի', 'քամու', 'փայլի', 'ուռած', 'հոգայ', 'դուրը', 'փրկեն', 'չարվի', 'հույն', 'կօգնէ', 'ճաշեր', 'այլոք', 'աղքատ', 'կռիւը', 'պտուղ', 'ներել', 'նորեկ', 'կղզու', 'մէկով', 'աբոնը', 'տաճար', 'առածի', 'ընկավ', 'քղորն', 'հրաշք', 'հիւթի', 'թավոտ', 'քոլեջ', 'ապրիք', 'արգամ', 'ուժեր', 'կրէին', 'որեւէ', 'գիտակ', 'մաղթէ', 'մտքին', 'ժայռն', 'սիրեն', 'մտոցը', 'նյութ', 'սնանի', 'նաւեր', 'ծովէն', 'հանել', 'քաշեն', 'կցում', 'հըլու', 'ծնոտի', 'կոշիկ', 'սկսեր', 'չափէն', 'հնդիկ', 'դրացի', 'առիթի', 'վագրը', 'սերմը', 'թխէին', 'դնէին', 'արժեք', 'սարքի', 'ֆոլիի', 'սկիզբ', 'իմանի', 'կտավն', 'կրկէս', 'զգալի', 'ծլում', 'ցորեն', 'մոտով', 'անտոք', 'հողից', 'ցեղեր', 'չինթա', 'նկարն', 'դադրի', 'տենդը', 'օձերի', 'յուղը', 'գառան', 'հինգը', 'գեյշա', 'քարով', 'թունդ', 'ելլեն', 'բարիք', 'դատին', 'հոսել', 'անինք', 'պոմպի', 'րոպեի', 'ջերմէ', 'գետով', 'պարոս', 'ստորև', 'նինան', 'շեփոր', 'շասսի', 'իշխող', 'երանգ', 'ալիբի', 'կարգը', 'տարիէ', 'տղմոտ', 'շեշտն', 'ափսէի', 'գները', 'հոկեյ', 'կարօտ', 'ձախող', 'պանրի', 'պրասն', 'դպչին', 'դիմաց', 'մղելէ', 'ձիրքն', 'վարեն', 'ցեղին', 'սխալի', 'շաբաթ', 'ռիսկի', 'լիճին', 'ուղիղ', 'կանաչ', 'զարնէ', 'քարից', 'տիրած', 'քիթին', 'հաճած', 'սուգը', 'բևեռի', 'փորձի', 'հատոր', 'ոջիլը', 'ֆավնը', 'կապեն', 'արքան', 'նաւվը', 'վայրի', 'հրեայ', 'ակնայ', 'վարեց', 'թախիծ', 'թռչնի', 'աղէտի', 'խելքը', 'հասաւ', 'սիրէր', 'զգոյշ', 'թխկին', 'ինկած', 'գոլէճ', 'սովին', 'հայցը', 'կաշին', 'պզտիկ', 'զրկած', 'ռենին', 'հաջող', 'կաթէն', 'ժամին', 'ժամից', 'լսելի', 'ելլող', 'կրքոտ', 'տանքա', 'պարոք', 'արդար', 'խաղէն', 'ցանցն', 'խոզեր', 'երկաթ', 'հթիռը', 'քուրտ', 'դառնա', 'ձգտող', 'գլխով', 'որոշէ', 'առկան', 'սեղմէ', 'շապիկ', 'սմքին', 'ձվերը', 'խոսել', 'լևինը', 'օդերի', 'եղնիկ', 'գրողն', 'թեւին', 'լսեցի', 'ուտեն', 'էլիսի', 'հատիկ', 'ֆոնդը', 'հաշվի', 'ուժով', 'շոճիի', 'ձուկի', 'շունչ', 'տենդի', 'գոյին', 'կարծէ', 'թևերի', 'հագին', 'կղզիի', 'պլոկը', 'պատվո', 'կրողը', 'կարագ', 'սոուս', 'անյագ', 'արայի', 'մեղրի', 'թրչել', 'խմբեր', 'լճերը', 'օտեան', 'նոյնը', 'սալոր', 'խմելէ', 'ծածկի', 'տանին', 'ձգտին', 'ժորժն', 'դանակ', 'տանիլ', 'ցնցող', 'օգնող', 'օսաքա', 'վերձը', 'դացին', 'հնարք', 'բակեր', 'հրատը', 'սնման', 'անհամ', 'արփին', 'մոկքի', 'թռիչք', 'կլանէ', 'մահու', 'պլանը', 'ոճերը', 'մարկը', 'առոյգ', 'իյնայ', 'սրտով', 'սարքը', 'ժողով', 'արխիվ', 'հնոցն', 'բացել', 'թթվով', 'ստորի', 'առթիվ', 'հնչակ', 'սեանը', 'զաւկի', 'հիմար', 'փուռը', 'հաւու', 'ցինկի', 'էթելը', 'մեռնի', 'դեղին', 'կտուր', 'Պոլիս', 'քունն', 'դարով', 'մտածէ', 'լիսեռ', 'մեթրն', 'աննան', 'Թամու', 'այգու', 'քորոց', 'օդում', 'նիւթի', 'պատով', 'վագրն', 'էպոլա', 'խորան', 'սրահը', 'հրշեջ', 'օրերի', 'կապիկ', 'դրված', 'միտքը', 'ճաշին', 'լիցքը', 'մարզն', 'կրօնը', 'նիքիի', 'լեզու', 'ձգուի', 'թուիլ', 'փտման', 'այսօր', 'անալի', 'մեթոտ', 'տարել', 'ադչու', 'շոփէն', 'թփերը', 'ձեռքն', 'նշեալ', 'մասիա', 'երգած', 'ակրան', 'մայրն', 'գիծին', 'բացեց', 'Գէորք', 'շահող', 'խունկ', 'ճտերի', 'մարել', 'նայթը', 'կեանք', 'շինել', 'ժանրի', 'պահեր', 'սիրել', 'մահով', 'ծածկը', 'ափսոս', 'մեկու', 'ողբեր', 'պաննո', 'բլուր', 'կազմի', 'տեղեր', 'հոտով', 'աւրել', 'կրցան', 'արծաթ', 'այդկէ', 'կավից', 'ժանրը', 'աթոռը', 'թալան', 'մատաղ', 'պարել', 'նւագէ', 'եռուն', 'նարեկ', 'ձիուց', 'լայտը', 'ցցված', 'թաղած', 'վիշտը', 'բռնած', 'սեքսը', 'արեւի', 'լամոն', 'աթոսի', 'ազնիվ', 'բարեի', 'լսենք', 'նմուշ', 'ածուխ', 'մորթը', 'անտառ', 'վարէն', 'նշում', 'ապակե', 'գազել', 'նուէր', 'տաճառ', 'երթին', 'անմեղ', 'բլոգը', 'թիրախ', 'բակէն', 'իրիսը', 'տպված', 'մեկին', 'հօրմէ', 'հոնկէ', 'հոսող', 'Մլեհը', 'հոյթէ', 'ժամվա', 'չատեր', 'դենդի', 'պարան', 'տոհմէ', 'զեւսը', 'մատով', 'թէյէն', 'բարակ', 'խորին', 'տրդատ', 'թրեքի', 'գծերն', 'գորգի', 'գցում', 'խոփեր', 'օծման', 'կեղևը', 'ասանկ', 'ուժին', 'մորթէ', 'խոցեր', 'մշակէ', 'քանին', 'փռված', 'արկին', 'կնքել', 'տեսքի', 'փօփին', 'ապասը', 'փոյին', 'հնուց', 'քալել', 'յօդին', 'երկրէ', 'գորքի', 'դիմակ', 'որդու', 'չփոխէ', 'պանիր', 'լոկին', 'փախիլ', 'սաղմի', 'դալար', 'անգամ', 'պտղին', 'վկայէ', 'ձևերի', 'հասան', 'տօննէ', 'ատենը', 'շերտի', 'ըսենք', 'քսում', 'քուրդ', 'տօնել', 'միւսը', 'խոտով', 'թոքեր', 'գրչին', 'մտնող', 'շենքը', 'տիարա', 'մնանք', 'ցանեն', 'աղման', 'ճարակ', 'հնչէր', 'ֆշշոց', 'ժխտել', 'գոյնը', 'փայտե', 'առնոն', 'ֆոնդի', 'շէնքէ', 'ջահեր', 'լավաշ', 'չխմեց', 'կիփսի', 'գիծով', 'արատի', 'բետոն', 'վէպին', 'նստած', 'մեջքի', 'լերան', 'նշեեն', 'տիպար', 'հարաւ', 'համակ', 'բերչի', 'ուտել', 'փուլի', 'գաւառ', 'կակաո', 'կեղևի', 'խաւեր', 'լոռիի', 'ցուլը', 'արկած', 'արթեն', 'գիտեք', 'անձին', 'փառքի', 'փչում', 'կռիւի', 'կինայ', 'լաստը', 'կխլեն', 'սկզբը', 'տակաւ', 'շփման', 'կոչեն', 'գիհիի', 'հացով', 'ֆրանց', 'զէնքն', 'հագել', 'ամենէ', 'մտնեն', 'իոսիֆ', 'ազնիւ', 'գացած', 'ապուշ', 'գերբի', 'սուրճ', 'ատիկա', 'կրօնք', 'ձգվել', 'գմբէթ', 'հացին', 'սպառէ', 'ելքին', 'երբևէ', 'աթոռի', 'դիետա', 'թփերի', 'սպասք', 'էմոյի', 'եզրին', 'սալսա', 'ամոմց', 'ղրկել', 'աոանց', 'ինչևէ', 'կնքած', 'փոշին', 'համեղ', 'համով', 'քեմոն', 'նորից', 'ժամեր', 'տօնած', 'գային', 'սղոցի', 'ձգտէր', 'գոյժը', 'անկախ', 'քսուք', 'ձիերը', 'ուսած', 'աղեղն', 'հաճար', 'ակասի', 'մարշը', 'սակաւ', 'մորթե', 'աւանդ', 'սարքր', 'պատեր', 'տղաքը', 'պտտին', 'շարժի', 'հեկել', 'Սատրի', 'փոքրը', 'կտակը', 'հռոմը', 'արշավ', 'յստակ', 'ընտիր', 'նայող', 'անլար', 'ինչոց', 'հռոմի', 'մէծէն', 'անտաշ', 'աղգատ', 'քանդէ', 'շքերթ', 'բնում', 'ծագել', 'դուռն', 'պսակի', 'ջոնսը', 'մեղքը', 'օղակը', 'բարձր', 'բոյսի', 'հատակ', 'կեսէն', 'երեքն', 'ալեւի', 'կէսէմ', 'գայլի', 'լուծի', 'հոսկէ', 'ամուր', 'էնդիի', 'ատամը', 'բունը', 'օսեյջ', 'գամեց', 'եղեռն', 'թերթի', 'ազատը', 'խաղով', 'տոմսի', 'շարել', 'համաս', 'թզուկ', 'պտոյտ', 'երգէն', 'կրիան', 'ապագա', 'զիջիր', 'ալբոմ', 'թուէր', 'մինչեւ', 'արյան', 'կրակի', 'ֆանդի', 'կաւով', 'տները', 'երկիր', 'զենքի', 'ձախից', 'մօրմէ', 'միսով', 'չէզոք', 'փայտէ', 'ֆորտէ', 'հիշել', 'լինին', 'զիջեց', 'տանել', 'երգէր', 'հետոյ', 'սլաքի', 'ձեւին', 'խռկոց', 'տղուն', 'հիդրո', 'հովիւ', 'իզուր', 'մետիա', 'խախտի', 'ձորան', 'արեթա', 'օտինը', 'պարեր', 'մղվել', 'վտանգ', 'թոքին', 'կայքը', 'պարապ', 'ծնողի', 'սպորտ', 'չգտաւ', 'դարան', 'մենակ', 'գիծեր', 'ղեկին', 'սուրբ', 'բռնել', 'կրոնը', 'էսսեն', 'սիանը', 'պնդեն', 'լանջի', 'շուէտ', 'այրած', 'պահած', 'թաղել', 'պայտի', 'անուս', 'ըլլար', 'ցուրտ', 'բազար', 'կրնաք', 'սնվել', 'չնչին', 'րոպէի', 'ժայռի', 'զրկեց', 'արտեր', 'բեմին', 'գավթի', 'արամն', 'բերդը', 'դասից', 'նամակ', 'սոտան', 'նետիկ', 'ոսկրը', 'մորից', 'քչերը', 'կռուի', 'դիմող', 'խմբին', 'հովիվ', 'փաստը', 'դրոշը', 'բերող', 'հնչած', 'ծովից', 'փորձն', 'ուխայ', 'բառեր', 'թորած', 'վարող', 'կշիռք', 'կաննի', 'ռիսկը', 'սրահն', 'ձգէին', 'նաֆթը', 'կույր', 'աուլը', 'քոյրը', 'այգով', 'գալով', 'յարկի', 'հարկը', 'նստել', 'ադամը', 'անձեր', 'գազար', 'մեղվի', 'ճաշից', 'հաշիվ', 'քունը', 'նկատի', 'խոնաւ', 'բայէն', 'կարող', 'սիլաս', 'տեղով', 'բացաւ', 'քարէն', 'պարտի', 'էյսան', 'գոշան', 'հսկել', 'անցնի', 'վտակն', 'վրանը', 'անդին', 'խրիմի', 'կոլոտ', 'կայքն', 'ուղտի', 'ըսուի', 'հոգու', 'ամփոփ', 'ցրման', 'կիրճի', 'բոված', 'մերոյ', 'տանող', 'կիսող', 'սպասէ', 'ներէն', 'բրնձի', 'կորած', 'ահւալ', 'հալիլ', 'հասակ', 'կռվեց', 'վեգան', 'պահակ', 'յաջող', 'ասիկա', 'անհատ', 'ձայնն', 'խաղար', 'խօսքի', 'շագին', 'խաչիկ', 'փունջ', 'էջում', 'աշուն', 'բխում', 'գովքը', 'թեփոտ', 'հազին', 'բրդյա', 'պրոնզ', 'գիքրը', 'վարդը', 'դդում', 'երկար', 'պահեն', 'պարկն', 'շէնքի', 'իւղին', 'պղնձէ', 'սառին', 'ծագած', 'կապել', 'նուազ', 'խօսքը', 'յանցն', 'ծոցին', 'փաքսի', 'չաթալ', 'որբեր', 'երդիկ', 'աւերը', 'ծախէր', 'զգեստ', 'նաֆտի', 'սիրոյ', 'զիջել', 'երեսը', 'նկատէ', 'շենքի', 'ասսատ', 'ծառեր', 'գուռի', 'վարէր', 'ծածկէ', 'երգով', 'ջեյնը', 'շարֆի', 'կաղին', 'կապան', 'դաշան', 'եզրից', 'օղաձև', 'նավթն', 'դպրաց', 'այգին', 'յարէր', 'նիկել', 'Երկրի', 'մթերք', 'լինեն', 'տարոն', 'վազող', 'գրեմի', 'երկին', 'պսակը', 'բլրակ', 'կենաց', 'ծռերը', 'աւանէ', 'օփերա', 'ամողջ', 'վիշապ', 'բույն', 'հարած', 'փայտը', 'քիմիա', 'սուէզ', 'օսկար', 'վարակ', 'ետեւէ', 'շարժը', 'կեպիի', 'քաղքի', 'շրջել', 'յղացք', 'տուկն', 'մազեր', 'մանկօ', 'տատէն', 'կոյտի', 'շիներ', 'բառով', 'չգտնի', 'չեզոք', 'զգում', 'պոեմը', 'վճիռը', 'վէպեր', 'զարդն', 'ծախել', 'Լևոնը', 'ալիքն', 'գրաֆը', 'էրճաս', 'մղիչը', 'կրճատ', 'ֆրակի', 'ռեյդի', 'ավարտ', 'նիքին', 'ժխտած', 'սուշի', 'կիսով', 'հուլա', 'էթնիք', 'գավառ', 'գահին', 'շփվել', 'կըսէր', 'կամքի', 'զատկի', 'թիմին', 'ոնրիշ', 'քտնէլ', 'նեխած', 'էկրան', 'զօրեղ', 'ազդել', 'քրամպ', 'անհոտ', 'արմատ', 'երեքը', 'ծախսէ', 'նաւով', 'խաղաց', 'ցանքի', 'նիստը', 'հեբեյ', 'տեղմը', 'խաչեր', 'շահել', 'թխուի', 'վերևի', 'թափեն', 'պալատ', 'տենտի', 'խաղից', 'հսկիչ', 'լցվել', 'պակտը', 'շինած', 'դէպքը', 'նոխազ', 'աղջիկ', 'բռնեն', 'աղիքի', 'բանով', 'զէնքի', 'կրիփը', 'ռեհան', 'բարեն', 'սեռէն', 'կարսի', 'տային', 'որմով', 'իւանը', 'պնդել', 'տիրան', 'բորոր', 'մեթոդ', 'ինչու', 'իրմով', 'օգնած', 'յարկը', 'ամիսն', 'ֆիլմն', 'սկսող', 'քելիի', 'քաշեց', 'մտնել', 'շփում', 'մուկը', 'խեցին', 'Ղազար', 'լքված', 'օթյակ', 'կիթառ', 'պղինձ', 'տակից', 'շենքն', 'ալիքը', 'մայոր', 'հյուր', 'նմոյշ', 'եղնար', 'թուալ', 'հանեց', 'բնոյթ', 'հեռու', 'վառեն', 'ժահրը', 'շոյել', 'խմորի', 'անքան', 'ճիմին', 'տպուի', 'փրկել', 'նոթեր', 'գետակ', 'վտանք', 'քարտե', 'փրկած', 'կոչած', 'խաղեր', 'զուրկ', 'խորքը', 'անյան', 'էդիթը', 'արքայ', 'նոճու', 'պահից', 'նշխար', 'շեշտը', 'ճաշակ', 'կողմի', 'կապած', 'գնման', 'նավով', 'թուով', 'Դևիդն', 'տարիի', 'ջորջը', 'լուրը', 'սրանց', 'հոսքի', 'կոմսը', 'արձակ', 'խթանէ', 'զտման', 'դեպքը', 'մօտիկ', 'տորան', 'բախտի', 'ձիուն', 'որդան', 'առակի', 'ոլորք', 'չմնաց', 'կատվի', 'ուժեղ', 'տրվել', 'հիւկօ', 'ոճիրի', 'ծառով', 'ապուր', 'լեմոն', 'ցանցը', 'հողին', 'խմելը', 'պարին', 'մարսի', 'թութք', 'բանչը', 'շարեն', 'հանձն', 'կաթից', 'իրինց', 'իրենը', 'սեռին', 'գրաւէ', 'լցոնը', 'անիմե', 'սիրող', 'գողեր', 'դերեը', 'գացող', 'փիլաւ', 'շախից', 'կազին', 'նավեր', 'կապրի', 'դիմեց', 'ցրտից', 'ջրում', 'փառքն', 'սիբան', 'գրելն', 'շալկէ', 'ձիւնը', 'կնոջը', 'ճնարը', 'փաշան', 'տզերը', 'սխալը', 'բրդից', 'առջևի', 'մուտք', 'փոսեր', 'խզում', 'գիտէր', 'ուրախ', 'շանյի', 'տեւեց', 'թեմէն', 'սխտոր', 'խաղալ', 'որսալ', 'կուզէ', 'ակաևի', 'գարին', 'դիտեն', 'ցցւիլ', 'վեպեր', 'մարած', 'հիմքն', 'հսկայ', 'երազը', 'դաշտը', 'մաշան', 'վերէն', 'գլուխ', 'գևորգ', 'նիստն', 'արշակ', 'տաբատ', 'մեխեց', 'մզկիթ', 'փիծծա', 'չարթի', 'նշաձև', 'ծառին', 'ողերն', 'մաշկը', 'պատիւ', 'անդրի', 'ինկող', 'լիոնը', 'եփում', 'շաման', 'ճզմել', 'Հայոց', 'լոնգի', 'տեսան', 'ճէյմի', 'շվաբը', 'տուրը', 'քրդեր', 'կոպիտ', 'ընկել', 'օգնել', 'խալաթ', 'չէինք', 'մարտի', 'թխում', 'Գէորգ', 'հինդի', 'կիրքը', 'գանգը', 'պահել', 'գնդակ', 'եռակի', 'սրտէն', 'վոլոֆ', 'արվեց', 'քամոտ', 'շնչեղ', 'արշտա', 'սիլլա'],
        Ia = "present",
        Ma = "correct",
        Oa = "absent";
    var Ra = {
