this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var La = ['գտնել', 'այսօր', 'երկիր', 'կրկին', 'անգամ', 'կարող', 'ցուրտ', 'որոնք', 'բանակ', 'առջեւ', 'արձակ', 'հազար', 'ուղիղ', 'զգալի', 'աւելի', 'դուրս', 'յաջող', 'խաղաղ', 'յաճախ', 'ուժեղ', 'երկար', 'դեղին', 'միջոց', 'բժիշկ', 'բարեւ', 'լուրջ', 'սկսիլ', 'բարձր', 'առանց', 'անդամ', 'ամուր', 'բերել', 'սկսաւ', 'հեռու', 'կանաչ', 'թեթեւ', 'անկախ', 'ծանօթ', 'կողմը', 'ուրիշ', 'քաղաք', 'միայն', 'հազիւ', 'համար', 'տեսակ', 'գնում', 'բոլոր', 'կեանք', 'նուրբ', 'օգնել', 'խումբ', 'աղքատ', 'սկսած', 'շուրջ', 'խոշոր', 'երկու', 'յաճախ', 'անուն', 'դպրոց', 'լեզու', 'վայրի', 'զաւակ', 'շրջան', 'աղջիկ','նուէր', 'ճահիճ', 'կարաս', 'փունջ', 'խնձոր', 'ապուր', 'իմաստ', 'ոսկոր', 'մշուշ', 'գազան', 'աքլոր', 'դաժան', 'մատիտ', 'կոճակ', 'թիթեղ', 'անվախ', 'առողջ', 'եզերք', 'գնդակ', 'արժէք', 'վտանգ', 'գիշեր', 'բուրդ', 'շապիկ', 'անտառ', 'արծաթ', 'անհատ', 'բողոք', 'ելոյթ', 'ոլորտ', 'որեւէ', 'կատակ', 'գաւաթ', 'մետաղ', 'աղօթք', 'չարիք', 'գնացք', 'պտուղ', 'չէզոք', 'քանոն', 'խաւար', 'փափաք', 'միջատ', 'ուրախ', 'դարակ', 'փշուր', 'բարակ', 'մարզիկ', 'երանգ', 'բեկոր', 'կօշիկ', 'դդում', 'ժանիք', 'երկաթ', 'կաթիլ', 'սունկ', 'հրդեհ', 'տերեւ', 'մթերք', 'նարօտ', 'ճկուն', 'ամայի', 'ծովափ', 'հրաշք', 'թուղթ', 'գլուխ', 'կաղին', 'համով', 'մոխիր', 'զրոյց', 'շաքար', 'կուշտ', 'գունդ', 'հսկայ', 'ծիրան', 'գոչել', 'շղթայ', 'ոչխար', 'խնդիր', 'արմաւ', 'սուրբ', 'բարիք', 'հաջող', 'տարազ', 'ծաղիկ', 'մուրճ', 'բաժին', 'դրախտ', 'աղտոտ', 'արիւն', 'հաշիւ', 'մեղու', 'հպարտ', 'փաթիլ', 'պտտիլ', 'եղնիկ', 'օժտել', 'հիւսք', 'ուղեղ', 'հատիկ', 'զատել', 'ապուռ', 'կմախք', 'մինչեւ', 'գրպան', 'բանալ', 'հարաւ', 'վհուկ', 'սալոր', 'համեմ', 'օգուտ', 'օրէնք', 'տխուր', 'մեխակ', 'գաւառ', 'մրրիկ', 'ականջ'],
